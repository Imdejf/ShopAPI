...
namespace Shop.MVC.Pages.Customer.Home
{
    [Authorize]
    public class DetailsModel : PageModel
    {
        ...
        public void OnGet(int id)
        {
            ...
            {
                MenuItem = _unitOfWork.MenuItem.GetFirstOrDefualt(includeProperties: "Category,FoodType", filter: c => c.Id == id),
                MenuItemId = id
            };
        }
        public IActionResult OnPost()
        {
            if(ModelState.IsValid)
            {
                ...
                ShoppingCart cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefualt(s => s.ApplicationUserId == ShoppingCartObj.ApplicationUserId &&
            ...
            {
                ShoppingCartObj.MenuItem = _unitOfWork.MenuItem.GetFirstOrDefualt(includeProperties: "Category,FoodType", filter: c => c.Id == ShoppingCartObj.MenuItemId);
                return Page();
            }
        }
    }
